...
ground_truths_path_3 = "/home/tomass/tomass/magistrs/video_annotating/pidgeon_datasets/test_datasets/pidgeon_test_4/part3.csv"
...
#     fExtract.save_image_to_lance_db_manual_features(image_path, vehicle_id, 1, saving_mode, feature_type=feature_type)
...
for index, row in file3.iterrows():
    ...
    if vehicle_id in seen_vehicle_ids:
        results_map = fExtract.compare_image_to_lance_db_manual_features(image_path, vehicle_id, 1, feature_type=feature_type)
        results(results_map)

...
parser.add_argument("--save_freq", default=2, type=int, #Originali bija 2
...
#parser.add_argument("--train_csv_path", default='../data/VRIC/vric_train.csv', required=True, type=str)

#parser.add_argument("--val_csv_path", default='../data/VRIC/vric_val.csv', required=True, type=str)

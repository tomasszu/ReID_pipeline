...
parser.add_argument("--train_csv_path", default='/home/tomass/tomass/data/VeRi_VehicX/VeRi+VehicX_train.csv', type=str)
#parser.add_argument("--train_csv_path", default='/home/toms.zinars/tomass/data/VeRi_VehicX/VeRi+VehicX_train.csv', type=str)

parser.add_argument("--val_csv_path", default='/home/tomass/tomass/data/VeRi_VehicX/VeRi+VehicX_val.csv', type=str)
...
parser.add_argument('--name', default='main_sampl_pc_4_181225',
...
parser.add_argument('--total_epoch', default=5,

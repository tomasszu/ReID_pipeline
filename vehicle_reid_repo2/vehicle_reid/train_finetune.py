...
parser.add_argument('--data_dir', default='/home/tomass/tomass/data/AIC22_Track1_MTMC_Tracking(1)/test/S06/c041', type=str, help='path to the dataset root directory')
#parser.add_argument('--data_dir', default='/home/toms.zinars/tomass/data', type=str, help='path to the dataset root directory')

parser.add_argument("--train_csv_path", default='/home/tomass/tomass/data/AIC22_Track1_MTMC_Tracking(1)/test/S06/c041/train.csv', type=str)
#parser.add_argument("--train_csv_path", default='/home/toms.zinars/tomass/data/VeRi_VehicX/VeRi+VehicX_train.csv', type=str)

parser.add_argument("--val_csv_path", default='/home/tomass/tomass/data/AIC22_Track1_MTMC_Tracking(1)/test/S06/c041/val.csv', type=str)
#parser.add_argument("--val_csv_path", default='/home/toms.zinars/tomass/data/VeRi_VehicX/VeRi+VehicX_val.csv', type=str)

parser.add_argument('--name', default='veri+vehixlex_editTrainPar1_Fisheye_finetune_1',
...
parser.add_argument('--total_epoch', default=56,
...
parser.add_argument("--checkpoint", default="vehicle_reid_repo2/vehicle_reid/model/veri+vehixlex_editTrainPar1/net_39.pth")

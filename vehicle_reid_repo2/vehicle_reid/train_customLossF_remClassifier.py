...
from customFunctions.CustomTripletLoss2 import CustomTripletLoss
...
from load_model_noClassifier import load_model_from_opts
...
parser.add_argument('--name', default='model_arch+loss_change4',

...
from custom_losses import OpenWorldBatchLoss
...
parser.add_argument('--name', default='base_CE_teacher',
...
def train_model(model, criterion, start_epoch=0, num_epochs=25, num_workers=2):
    ...
    train_sampler = PKCrossCamSampler(
        image_datasets["train"], opt.batchsize, opt.samples_per_class, min_cams_per_class=cams_per_id, num_batches = num_batches)

...
parser.add_argument("--train_csv_path", default='/home/tomass/tomass/magistrs/video_annotating/pidgeon_datasets/train_datasets/pidgeon_train_4/train.csv', type=str)
#parser.add_argument("--train_csv_path", default='/home/toms.zinars/tomass/data/VeRi_VehicX/VeRi+VehicX_train.csv', type=str)

parser.add_argument("--val_csv_path", default='/home/tomass/tomass/magistrs/video_annotating/pidgeon_datasets/train_datasets/pidgeon_train_4/val.csv', type=str)
#parser.add_argument("--val_csv_path", default='/home/toms.zinars/tomass/data/VeRi_VehicX/VeRi+VehicX_val.csv', type=str)

parser.add_argument('--name', default='Pidgeon_model_4_no_CE',

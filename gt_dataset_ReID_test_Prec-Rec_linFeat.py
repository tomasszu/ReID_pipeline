...
for index, row in file1.iterrows():
    ...
    fExtract.save_image_to_lance_db_linear_features(image_path, vehicle_id, 1, saving_mode, feature_type='Combined')
...
for index, row in file3.iterrows():
    ...
    if vehicle_id in seen_vehicle_ids:
        results_map = fExtract.compare_image_to_lance_db_linear_features(image_path, vehicle_id, 1, feature_type='Combined')
        results(results_map)

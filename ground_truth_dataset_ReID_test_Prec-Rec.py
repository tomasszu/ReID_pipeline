...
data_dir = '/home/toms.zinars/Anzelika'

ground_truths_path_1 = "/home/toms.zinars/Anzelika/EDI_Cam_testData/cam1.csv"

ground_truths_path_2 = "/home/toms.zinars/Anzelika/EDI_Cam_testData/cam2.csv"


ground_truths_path_3 = "/home/toms.zinars/Anzelika/EDI_Cam_testData/cam3.csv"
...
for index, row in file1.iterrows():
    ...
    fExtract.save_image_to_lance_db(image_path, vehicle_id, 2, saving_mode)
...
for index, row in file2.iterrows():
    ...
    if vehicle_id in seen_vehicle_ids:
        results_map = fExtract.compare_image_to_lance_db(image_path, vehicle_id, 2)
        results(results_map)

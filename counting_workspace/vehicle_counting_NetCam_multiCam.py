...
line_zone_annotator2 = counter.LineZoneAnnotator(thickness=2, text_thickness=2, text_scale=1, color=sv.Color.red())
...
tracker2 = sv.ByteTrack(track_thresh = 0.25, track_buffer = 30, match_thresh = 0.7, frame_rate = 4 )#BYTETrackerArgs())
...
line2 = counter.LineZone(point1, point2)
...
while True:
    ...
    if i%1 == 0:
        ...
        line2.trigger(detections=detections2)
        ...
        annotated_frame2 = line_zone_annotator2.annotate(frame=annotated_frame2, line_counter=line2)
            # # annotated_frame = zone_annotator.annotate(
        ...
        resized2 =  cv2.resize(annotated_frame2, (1280, 720))
        cv2.imshow(f"{CAMERA_ADDRESS2}", resized2)

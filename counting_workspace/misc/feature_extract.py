...
def save_extractions_to_lance_db(folder_path, folder_name):
    ...
    model = load_model_from_opts("/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/vric_unmodified/opts.yaml", ckpt="/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/vric_unmodified/net_19.pth", remove_classifier=True)
    model.eval()
    model.to(device)

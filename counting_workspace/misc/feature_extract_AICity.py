...
def save_extractions_to_lance_db(folder_path, folder_name, saving_mode):
    ...
    model = load_model_from_opts("/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/vric+veri_unmodified/opts.yaml", ckpt="/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/vric+veri_unmodified/net_15.pth", remove_classifier=True)
...
def save_image_to_lance_db(image_path, vehicle_id, folder_name, saving_mode):
    ...
    model = load_model_from_opts("/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/vric+vehixlex_unmodified/opts.yaml", ckpt="/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/vric+vehixlex_unmodified/net_28.pth", remove_classifier=True)
    #print(model)
    model.eval()
    model.to(device)

...
def save_extractions_to_lance_db(folder_path, folder_name, saving_mode):
    ...
    # print(model)
    model = load_model_from_opts("/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/model_arch_change4/opts.yaml", ckpt="/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/model_arch_change4/net_42.pth", remove_classifier=True)
    #print(model)
    model.eval()
    model.to(device)

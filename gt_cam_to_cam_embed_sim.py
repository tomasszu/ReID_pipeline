...
if __name__ == "__main__":
    ...
    if CLIP:
        ...
        model = load_model_from_opts(
            "/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/CE_triplet_cam_loss/opts.yaml",
            ckpt="/home/tomass/tomass/ReID_pipele/vehicle_reid_repo2/vehicle_reid/model/CE_triplet_cam_loss/net_30.pth",
            remove_classifier=True,
            return_pre_bn=True)
        model.eval()
        model.to(device)
